...
class ProductController {
  ...
  Future<http.Response> InsertProduct(BuildContext context, String productName,
    ...
    try {
      ...
      final response = await http.post(
        Uri.parse(
            "$apiURI/api/product"), // Replace with the correct API endpoint
        headers: {
          "Content-Type": "application/json",
  ...
  Future<http.Response> updateProduct(BuildContext context, String productId,
    ...
    try {
      ...
      final response = await http.put(
        Uri.parse(
            "$apiURI/api/product/$productId"), // Replace with the correct API endpoint
        headers: {
          "Content-Type": "application/json",
          "Authorization": "Bearer $accessToken" // Attach accessToken
        },
  ...
  Future<http.Response> deleteProduct(BuildContext context, String productId) async {
    final userProvider = Provider.of<UserProvider>(context, listen: false);
    var accessToken = userProvider.accessToken;

    try {
      final response = await http.delete(
        Uri.parse("$apiURI/api/product/$productId"),
        headers: {
          "Content-Type": "application/json",
